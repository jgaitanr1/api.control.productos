package com.controlproductos.api.controllers;
...
import com.controlproductos.api.models.ERole;
import com.controlproductos.api.models.Role;
import com.controlproductos.api.models.User;
import com.controlproductos.api.payload.request.ChangePasswordRequest;
import com.controlproductos.api.payload.request.LoginRequest;
import com.controlproductos.api.payload.request.SignupRequest;
import com.controlproductos.api.payload.response.MessageResponse;
import com.controlproductos.api.payload.response.UserInfoResponse;
import com.controlproductos.api.repository.RoleRepository;
import com.controlproductos.api.repository.UserRepository;
import com.controlproductos.api.security.jwt.JwtUtils;
import com.controlproductos.api.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE, jwtCookie.toString()).body(
				new UserInfoResponse(userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(),
						...
						userDetails.getFecNacimiento(), userDetails.getNroTelefono(), userDetails.isEstado(), roles));
	}
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		User user = new User(signUpRequest.getUsername(), signUpRequest.getEmail(),
				...
				signUpRequest.getFecNacimiento(), signUpRequest.getNroTelefono(), 
